...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <DynamicContactForm location="Rajasthan" domain="mewadisafa.com" />
      <GallerySection />
      <DynamicServicesSection location="Rajasthan" domain="mewadisafa.com" />
      <DynamicFooter location="Rajasthan" domain="mewadisafa.com" />
      <WhatsAppFloat />
    </main>
  )
}
